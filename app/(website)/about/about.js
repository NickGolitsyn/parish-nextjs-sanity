    ...
    <Container>
      <div className="my-10">
        ...
        <div className="mx-auto prose text-center dark:prose-invert mt-14">
          <p>{about?.about || `We belong to the Romanian Orthodox Metropolis of Western and Southern Europe  (part of the Romanian Patriarchate) led by His Eminence Iosif, Archbishop and Metropolitan.
